...
const Head = () => {
  return (
    <div className="flex justify-between px-[5%] w-full">
        ...
        <span className="font-bold text-5xl text-transparent bg-clip-text bg-gradient-to-b from-[#E8211A] to-[#eb423c]">
          ZONELS
        </span>
      </div>
      <div className="hidden lg:flex items-center gap-5">
        <Headcompo
          ...
          style="font-medium text-[#E8211A] text-lg"
        />
        <Headcompo 
          Icon={<PhoneAndroidIcon style={{ color: '#8B8B8B', fontSize: 40 }} />}
          text1="Call Us Anytime"
          text2="+2348064845313"
          style="font-medium text-2xl text-[#E8211A]"
        />
